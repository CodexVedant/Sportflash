...
// Error Fallback UI
export const ErrorFallback: React.FC<ErrorFallbackProps> = ({ error, resetError, showDetails = false }) => {
    return (
...
// API Error Component
export const ApiError: React.FC<ApiErrorProps> = ({ onRetry, message, statusCode }) => {
