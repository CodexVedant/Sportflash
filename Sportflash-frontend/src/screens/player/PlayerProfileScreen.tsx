...
export default function PlayerProfileScreen({ route, navigation }: Props) {
    ...
    // TODO: Verify useGetPlayerDetailsQuery params object structure in actual definition
    // Assuming { id, sport } is correct based on previous JS analysis
    const { data: playerData, isLoading } = useGetPlayerDetailsQuery({ id, sport }, { skip: !id });
