...
export default function PlayerCard({ player, onPress, compact = false }: PlayerCardProps) {
    if (compact) {
        return (
            <TouchableOpacity style={styles.compactCard} onPress={onPress}>
                {player.image && <Image source={{ uri: player.image }} style={styles.compactImage} />}
    ...
    return (
        <TouchableOpacity style={styles.card} onPress={onPress} activeOpacity={0.9}>
            ...
            <View style={styles.imageWrapper}>
                {player.image && <Image source={{ uri: player.image }} style={styles.image} />}
