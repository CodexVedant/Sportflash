...
import { styles } from '@utils/style/Skeleton.styles';
...
const ShimmerPlaceholder: React.FC<ShimmerPlaceholderProps> = ({ width, height, borderRadius = 8, style }) => {
        ...
        <View
            style={[
                styles.skeleton,
                {
                    ...
                    borderRadius,
                    overflow: 'hidden',
                } as any, // ViewStyle casting for percentage strings
                style,
            ]}
        >
            <Animated.View
...
export const SkeletonList: React.FC<SkeletonListProps> = ({ type = 'match', count = 3 }) => {
...
// Generic Skeleton
export const Skeleton: React.FC<ShimmerPlaceholderProps> = ({ width, height, borderRadius, style }) => {
