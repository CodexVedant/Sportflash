...
export default function NotificationOptionsModal({ visible, onClose, match, onSave, initialPreferences = {} }) {
                        ...
                        <View style={styles.optionRow}>
                            <View style={styles.labelContainer}>
                                ...
                                <View style={{ marginLeft: 12 }}>
                                    ...
                                    <Text style={styles.optionDesc}>All matches in {match.league}</Text>
                                </View>
                            </View>
                            <Switch
